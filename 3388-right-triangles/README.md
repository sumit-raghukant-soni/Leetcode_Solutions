<h2><a href="https://leetcode.com/problems/right-triangles">Right Triangles</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given a 2D boolean matrix <code>grid</code>.</p>
