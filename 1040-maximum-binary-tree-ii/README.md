<h2><a href="https://leetcode.com/problems/maximum-binary-tree-ii">Maximum Binary Tree II</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>A <strong>maximum tree</strong> is a tree where every node has a value greater than any other value in its subtree.</p>
