<h2><a href="https://leetcode.com/problems/design-a-text-editor">Design a Text Editor</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>Design a text editor with a cursor that can do the following:</p>
